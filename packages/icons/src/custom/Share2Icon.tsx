...
const Share2 = React.forwardRef<SVGSVGElement, IconProps>(({ color = 'currentColor', ...props }, forwardedRef) => {
  return (
    <svg
      width="15"
      height="15"
...
export const Share2Icon: ReturnType<typeof convertSvgIconToIcon> = convertSvgIconToIcon(Share2);
