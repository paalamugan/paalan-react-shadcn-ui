...
import type { BoxProps } from '@paalan/react-layouts';
import type { ComponentWithAs } from '@paalan/react-shared/types';
import type { VariantProps } from 'class-variance-authority';

import { SolidCloseIcon } from '@paalan/react-icons';
 ...
 */
export const Alert: ComponentWithAs<'div', AlertProps> = forwardRef<AlertProps, 'div'>(
          ...
          <AlertRoot {...props} ref={ref}>
            ...
            {dismissible && (
              <IconButton
                ...
                icon={<SolidCloseIcon className="size-5" />}
              />
            )}
          </AlertRoot>
        )}
