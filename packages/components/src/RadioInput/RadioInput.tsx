...
import { Box, Flex } from '@paalan/react-layouts';
...
const radioVariants = cva(
  'peer inline-block size-4 cursor-pointer appearance-none rounded-full border border-gray-300 bg-background align-middle text-primary checked:border-transparent checked:bg-current focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-current focus-visible:ring-offset-2 disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-gray-100 disabled:opacity-50',
);
