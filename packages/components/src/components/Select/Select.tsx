...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <CaretSortIcon className="size-4 opacity-80" />
...
export interface SelectProps extends Omit<React.ComponentProps<typeof SelectRoot>, 'children'> {
  /**
    ...
    return (
      <>
        ...
        >
          ...
          <SelectRoot {...props} required={required} value={localValue} onValueChange={setLocalValue}>
            <SelectTrigger
              className={cn(
            ...
            <SelectContent className={contentClassName}>
              {!groups.length ? (
                <Text className="px-3 py-1 text-center text-sm text-gray-500">{noOptionsMessage}</Text>
              ) : (
